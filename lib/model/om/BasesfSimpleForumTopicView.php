...
/**
 * Base class that represents a row from the 'sf_simple_forum_topic_view' table.
 *
 * 
 *
...
abstract class BasesfSimpleForumTopicView extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfSimpleForumTopicViewPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        sfSimpleForumTopicViewPeer
	 */
	...
	/**
	 * Initializes internal state of BasesfSimpleForumTopicView object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     sfSimpleForumTopicView The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = sfSimpleForumTopicViewPeer::NUM_COLUMNS - sfSimpleForumTopicViewPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = sfSimpleForumTopicViewPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasesfSimpleForumTopicView:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			sfSimpleForumTopicViewPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of sfSimpleForumTopicView (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     sfSimpleForumTopicView Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     sfSimpleForumTopicViewPeer
	 */
	...
	public function setsfGuardUser(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addsfSimpleForumTopicView($this);
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addsfSimpleForumTopicViews($this);
			 */
		}
	...
	public function getsfSimpleForumTopic(PropelPDO $con = null)
	{
		if ($this->asfSimpleForumTopic === null && ($this->topic_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfSimpleForumTopic->addsfSimpleForumTopicViews($this);
			 */
		}
